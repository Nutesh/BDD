...
public class HotelLoginPageFactory {
	...
	@CacheLookup
	WebElement userName;//it is a reference to WebElement on login.html
	...
	public HotelLoginPageFactory(WebDriver driver) {
		this.driver = driver;
		PageFactory.initElements(driver, this);//it configures driver with the
		//pom class and with PageFactory
	}
